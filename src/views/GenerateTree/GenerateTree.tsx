...
function GenerateTree() {
    ...
    const startGenerate = (form: any) => {
        ...
        saveLocalJSON("GenerateTreeForm", form.getFieldsValue());
        let formData = new FormData();
        if (!form.getFieldsValue().inputData?.useExampleAlignmentFile) formData.append("alignment", form.getFieldsValue().inputData.alignmentFile.file);
    ...
    console.log(loadLocalJSON("GenerateTreeForm"));
    const [, forceRender] = useState();
    const r = loadLocalJSON("GenerateTreeForm") ?? Model.clone<GenerateTreeRequest>(
        {
